  ...
  return (
    <SafeAreaView style={{backgroundColor: theme.colors.primary}}>
        <View style={styles.HeaderContainer}>
            <Text style={{fontSize: theme.fontSize.medium, color:theme.colors.text}}> Bonjour, {user?.prenom}</Text>
            <Menu
             visible={visible}
             onDismiss={closeMenu}
             anchor={
                <TouchableOpacity onPress={openMenu}>
                    <Image contentFit="fill"  style={styles.AvatarWrapper} source={ user?.avatar}/>
                </TouchableOpacity>
             }
             >
